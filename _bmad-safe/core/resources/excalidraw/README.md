...
helpers: '{project-root}/_bmad-safe/core/resources/excalidraw/excalidraw-helpers.md'
json_validation: '{project-root}/_bmad-safe/core/resources/excalidraw/validate-json-instructions.md'
```
