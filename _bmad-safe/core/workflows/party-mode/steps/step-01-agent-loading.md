...
- Agent manifest CSV is available at `{project-root}/_bmad-safe/_config/agent-manifest.csv`
...
Load and parse the agent manifest CSV from `{project-root}/_bmad-safe/_config/agent-manifest.csv`
