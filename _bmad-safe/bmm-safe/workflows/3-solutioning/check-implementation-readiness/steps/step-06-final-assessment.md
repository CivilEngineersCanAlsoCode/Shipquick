...
# Path Definitions
workflow_path: '{project-root}/_bmad-safe/bmm-safe/workflows/3-solutioning/implementation-readiness'
...
Implementation Readiness complete. Read fully and follow: `_bmad-safe/core/tasks/bmad-help.md` with argument `implementation readiness`.
