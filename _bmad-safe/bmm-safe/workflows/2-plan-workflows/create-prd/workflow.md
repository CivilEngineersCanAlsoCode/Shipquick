...
main_config: "{project-root}/_bmad-safe/bmm-safe/config.yaml"
...
# PRD Workflow (Tri-Modal, SAFe-Aligned)

**Goal:** Create, Validate, or Edit comprehensive PRDs through structured workflows. In SAFe, PRDs align with **Strategic Themes** and prepare work for **WSJF prioritization**.
...
- **Strategic Theme Alignment**: PRD should trace to portfolio-level Strategic Themes
- **WSJF Readiness**: Features defined in PRD should support WSJF calculation (Value, Time Criticality, Risk, Size)
- **Capability vs Feature**: Distinguish solution-level Capabilities from ART-level Features
- **Business Owner Involvement**: Critical decisions require Business Owner input
