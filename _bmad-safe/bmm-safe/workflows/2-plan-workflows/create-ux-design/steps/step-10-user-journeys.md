...
- Read fully and follow: {project-root}/_bmad-safe/core/workflows/advanced-elicitation/workflow.xml with the current user journey content
...
- Read fully and follow: {project-root}/_bmad-safe/core/workflows/party-mode/workflow.md with the current user journeys
