...
- When 'A' selected: Read fully and follow: {project-root}/_bmad-safe/core/workflows/advanced-elicitation/workflow.xml
- When 'P' selected: Read fully and follow: {project-root}/_bmad-safe/core/workflows/party-mode/workflow.md
...
- Read fully and follow: {project-root}/_bmad-safe/core/workflows/advanced-elicitation/workflow.xml with the current responsive/accessibility content
...
- Read fully and follow: {project-root}/_bmad-safe/core/workflows/party-mode/workflow.md with the current responsive/accessibility strategy
