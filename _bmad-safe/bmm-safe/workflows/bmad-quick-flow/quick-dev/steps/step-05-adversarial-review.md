...
workflow_path: '{project-root}/_bmad-safe/bmm-safe/workflows/bmad-quick-flow/quick-dev'
...
```xml
<invoke-task>Review {diff_output} using {project-root}/_bmad-safe/core/tasks/review-adversarial-general.xml</invoke-task>
```
