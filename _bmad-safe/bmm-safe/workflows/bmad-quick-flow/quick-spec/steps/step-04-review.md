...
workflow_path: '{project-root}/_bmad-safe/bmm-safe/workflows/bmad-quick-flow/quick-spec'
...
1. **Invoke Adversarial Review Task**:
       ...
       <invoke-task>Review {finalFile} using {project-root}/_bmad-safe/core/tasks/review-adversarial-general.xml</invoke-task>
