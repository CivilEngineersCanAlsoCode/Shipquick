...
- The `{project-root}/_bmad-safe/core/tasks/validate-workflow.xml` framework will automatically:
...
3. **Load validation framework**: `{project-root}/_bmad-safe/core/tasks/validate-workflow.xml`
