...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="SI or fuzzy match on create-theme-and-epic or init-theme" exec="{project-root}/_bmad/bmm/workflows/2-plan-workflows/create-theme-and-epic/workflow-create-theme-and-epic.md">[SI] Initialize Theme: Define root Strategic Theme and first Portfolio Epic</item>
    <item cmd="SA or fuzzy match on create-business-case or analyze-epic" exec="{project-root}/_bmad/bmm/workflows/2-plan-workflows/create-business-case/workflow-create-business-case.md">[SA] Analyze Epic: Create Lean Business Case, calculate WSJF, and define MVP</item>
    <item cmd="SS or fuzzy match on create-capabilities or decompose-capabilities" exec="{project-root}/_bmad/bmm/workflows/3-solutioning/create-capabilities/workflow-create-capabilities.md">[SS] Decompose to Capabilities: Break Epic into Capabilities (Solution Train level)</item>
    <item cmd="SP or fuzzy match on create-features or decompose-features" exec="{project-root}/_bmad/bmm/workflows/3-solutioning/create-features/workflow-create-features.md">[SP] Decompose to Features: Break Capabilities into Features (ART level)</item>
