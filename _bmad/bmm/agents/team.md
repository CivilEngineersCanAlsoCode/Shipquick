...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="SE or fuzzy match on create-stories or execute" exec="{project-root}/_bmad/bmm/workflows/4-implementation/create-stories/workflow-create-stories.md">[SE] Execute Breakdown: Decompose Features into Stories, Dev Tasks, and QA Cases</item>
