...
description: "Resume an interrupted Theme & Epic workflow from the last completed step"
...
Resume the Theme & Epic workflow from where it was left off, ensuring smooth continuation with full context restoration.
...
- IF A: Route back to `step-01-theme.md`.
