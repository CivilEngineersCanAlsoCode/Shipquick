...
description: "Resume an interrupted Features workflow from the last completed step"

# File References
outputFile: "{sq_output_folder}/features-{cap_id}.md"
---
...
Resume the Features workflow from where it was left off, ensuring smooth continuation with full context restoration.
...
"Welcome back {user_name}! I've analyzed your progress on the Features decomposition.
...
- IF A: Route back to `step-01-load-cap.md`.
