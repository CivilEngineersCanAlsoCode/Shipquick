...
description: "Resume an interrupted Capabilities workflow from the last completed step"

# File References
outputFile: "{sq_output_folder}/capabilities-{epic_id}.md"
---
...
Resume the Capabilities workflow from where it was left off, ensuring smooth continuation with full context restoration.
...
"Welcome back {user_name}! I've analyzed your progress on the Capabilities decomposition.
...
- IF A: Route back to `step-01-load-epic.md`.
