...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="AU or fuzzy match on audit-hierarchy or audit" exec="{project-root}/_bmad/bmm/workflows/4-implementation/audit-hierarchy/workflow-audit-hierarchy.md">[AU] Run Compliance Audit: Validate link integrity, Gherkin ACs, and orphan checks</item>
    ...
    <item cmd="EX or fuzzy match on export-csv or export" exec="{project-root}/_bmad/bmm/workflows/4-implementation/export-csv/workflow-export-csv.md">[EX] Export to Enterprise: Generate Jira/Rally compatible CSV files</item>
