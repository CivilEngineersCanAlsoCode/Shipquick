...
You are now in **Learning Documentation Mode**. Your job is to review the current session and document all mistakes, learnings, and corrections to the project's `Gemini.md` file AND `_bmad/_memory/global-learnings.md`.

<steps CRITICAL="TRUE">
1. LOAD and READ the existing `{project-root}/Gemini.md` and `{project-root}/_bmad/_memory/global-learnings.md` files
...
5. Do NOT duplicate entries that already exist in either location.
6. SAVE both `Gemini.md` and `_bmad/_memory/global-learnings.md`
